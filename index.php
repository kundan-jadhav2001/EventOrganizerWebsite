...
<section class="service" id="service">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="venueselection.html" class="btn">Venue Selection</a>
            <p>the following are a number of venues that Dream Planner Ltd suggests for your events. Get in touch for the best deals possibleVenue owners who would like to list their venues are kindly requested to email us on info@myeventplanner.com.mt in order to arrange a viewing.
                Corporate Events,Venues Social Events Venues,Wedding Venues </p>
        </div>

        <div class="box">
            <i class="fas fa-envelope"></i>
            
            <a href="Invetation Card.html" class="btn">Invetation Card</a>
            <p></p>
        </div>
...
<div class="theme-toggler">
    ...
    <div class="buttons">
        ...
        <div class="theme-btn" style="background: #962ad0;"></div>
        <div class="theme-btn" style="background: #ff00334e;"></div>
        <div class="theme-btn" style="background: #f4f7f6;"></div>
